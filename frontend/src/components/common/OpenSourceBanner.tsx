...
function MicrosoftLogo({ size = 12 }: { size?: number }) {
  return (
    ...
    >
      ...
      <div className="relative min-w-[200px] flex-1">
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-[13px] font-bold tracking-[-0.2px] text-fg">Cover Letter Local is open source</span>
          <span className="inline-flex items-center gap-1.5 rounded-full border border-border bg-surface-2 px-1.5 py-0.5">
            <MicrosoftLogo />
            <span className="text-[12px] font-semibold text-fg-mid">Microsoft internship</span>
          </span>
        </div>
        <p className="mt-1 max-w-[520px] text-[13px] leading-snug text-fg-mid">
      ...
      <div className="relative flex shrink-0 gap-2">
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-[9px] border border-accent bg-accent-weak px-3 py-2 text-[13px] font-semibold text-accent-text no-underline"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 rounded-[9px] border border-border-strong bg-surface px-3 py-2 text-[13px] font-semibold text-fg no-underline"
        >
          View source
